...
private:
  ...
  double lock_id_ = -1;
  int outpost_aim_lock_id_ = -1;       // outpost: which plate is locked for prediction
  int outpost_aim_lock_frames_ = 999;  // outpost: hysteresis counter for prediction switch
